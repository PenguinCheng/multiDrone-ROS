...
//
void serialDataReceived(const std_msgs::String::ConstPtr& msg){
...
int main(int argc, char **argv){
  ...
  gps_pub = nodeHandle.advertise<std_msgs::String>("serial_data_send", 10);
  ros::Subscriber serialSubscriber = nodeHandle.subscribe("serial_data_received", 10, serialDataReceived);
...
//ros rate 
  ...
  while(ros::ok())
  {
      ...
      std_msgs::String gps_location;
      std::stringstream ss;
      ss << "o120.11111111a30.3333333333#";
      gps_location.data = ss.str();
